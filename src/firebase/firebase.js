...
class Authen extends Component {
    ...
    googleSignin = () => {
        ...
        // });
        // let promise = firebase.auth().signInWithRedirect(provider)
        promise
            .then(result => {
    ...
    //Logout for firebase authentication
    logout = () => {
        ...
        firebase.auth().signOut()
            ...
            () => {
                ...
                let newWindow = window.open('https://mail.google.com/mail/?logout&hl=en', 'Disconnect from Google', 'width=500,height=600,menubar=no,status=no,location=no,toolbar=no,scrollbars=no,top=200,left=200');
                setTimeout(function () {
